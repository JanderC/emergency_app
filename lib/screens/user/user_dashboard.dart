...
import 'package:app_emergency/screens/user/quick_report_screen.dart';
...
class _UserDashboardState extends State<UserDashboard> {
  ...
  Future<void> _loadDashboardData() async {
    ...
    try {
      await Future.wait([_loadIncidents(), _loadNotifications()]);
    } catch (e) {
      setState(() {
  ...
  Future<void> _loadNotifications() async {
    try {
      final notifications = await _userService.getUserNotifications(
        soloNoLeidas: true,
      );
      setState(() {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          TextButton(onPressed: _showNotifications, child: const Text('Ver')),
        ],
      ),
    );
  }
  ...
  Widget _buildQuickActions() {
    return Container(
      ...
      child: Column(
        children: [
          // Botón de emergencia rápida (destacado)
          Container(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const QuickReportScreen(),
                    ),
                  ).then((_) => _loadDashboardData());
                },
