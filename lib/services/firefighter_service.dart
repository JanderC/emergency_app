...
class FirefighterService {
  final String baseUrl = 'https://emergencyapi-production.up.railway.app/api/bomberos';
  ...
  Future<Map<String, dynamic>> completeIncident(String incidentId) async {
    try {
      ...
      final response = await http.put(
        Uri.parse(
          'https://emergencyapi-production.up.railway.app/api/incidentes/$incidentId/completar',
